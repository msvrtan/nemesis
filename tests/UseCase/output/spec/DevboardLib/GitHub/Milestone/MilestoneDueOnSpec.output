...
class MilestoneDueOnSpec extends ObjectBehavior
{
    public function let()
    {
    ...
    {
        $this->shouldHaveType(MilestoneDueOn::class);
    ...
    {
        $this->deserialize('2018-01-01T11:22:33+00:00')->shouldReturnAnInstanceOf(MilestoneDueOn::class);
    }
}
