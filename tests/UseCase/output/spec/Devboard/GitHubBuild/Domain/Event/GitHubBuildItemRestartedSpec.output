...
class GitHubBuildItemRestartedSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(GitHubBuildItemRestarted::class);
    ...
    {
        $this->create($buildId, $status)->shouldReturnAnInstanceOf(GitHubBuildItemRestarted::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(GitHubBuildItemRestarted::class);
    }
}
