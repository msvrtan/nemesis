...
class GitHubBuildItemCreatedSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(GitHubBuildItemCreated::class);
    ...
    {
        $this->create($buildId, $status)->shouldReturnAnInstanceOf(GitHubBuildItemCreated::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(GitHubBuildItemCreated::class);
    }
}
