...
class GitHubBuildItemFailureSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(GitHubBuildItemFailure::class);
    ...
    {
        $this->create($buildId, $status)->shouldReturnAnInstanceOf(GitHubBuildItemFailure::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(GitHubBuildItemFailure::class);
    }
}
