...
namespace Devboard\GitHubRepo\Core;

/**
 * @see \spec\Devboard\GitHubRepo\Core\GitHubRepoRootIdSpec
 * @see \Tests\Devboard\GitHubRepo\Core\GitHubRepoRootIdTest
 */
class GitHubRepoRootId
{
    /** @var string */
