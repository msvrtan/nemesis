...
/**
 * @see \spec\Devboard\GitHubBuild\Domain\Event\GitHubBuildItemFailureSpec
 * @see \Tests\Devboard\GitHubBuild\Domain\Event\GitHubBuildItemFailureTest
 */
class GitHubBuildItemFailure implements GitHubBuildEvent, GitHubBuildItemEvent, Serializable
{
    /** @var GitHubBuildId */
    private $buildId;
