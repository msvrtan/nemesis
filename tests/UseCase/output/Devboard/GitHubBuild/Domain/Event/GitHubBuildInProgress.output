...
/**
 * @see \spec\Devboard\GitHubBuild\Domain\Event\GitHubBuildInProgressSpec
 * @see \Tests\Devboard\GitHubBuild\Domain\Event\GitHubBuildInProgressTest
 */
class GitHubBuildInProgress implements GitHubBuildEvent, Serializable
{
    /** @var GitHubBuildId */
    private $buildId;
