...
/**
 * @see \spec\Devboard\GitHubBuild\Domain\Event\GitHubBuildItemRestartedSpec
 * @see \Tests\Devboard\GitHubBuild\Domain\Event\GitHubBuildItemRestartedTest
 */
class GitHubBuildItemRestarted implements GitHubBuildEvent, GitHubBuildItemEvent, Serializable
{
    /** @var GitHubBuildId */
    private $buildId;
