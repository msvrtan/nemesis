...
/**
 * @see \spec\Devboard\GitHubBuild\Domain\Event\GitHubBuildFailedSpec
 * @see \Tests\Devboard\GitHubBuild\Domain\Event\GitHubBuildFailedTest
 */
class GitHubBuildFailed implements GitHubBuildEvent, Serializable
{
    /** @var GitHubBuildId */
    private $buildId;
