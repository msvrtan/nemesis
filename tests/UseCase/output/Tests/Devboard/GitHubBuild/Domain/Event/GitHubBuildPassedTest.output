...
use Devboard\GitHubBuild\Domain\Event\GitHubBuildPassed;
use PHPUnit\Framework\TestCase;

/**
 * @covers \Devboard\GitHubBuild\Domain\Event\GitHubBuildPassed
 * @group  todo
 */
class GitHubBuildPassedTest extends TestCase
{
    /** @var GitHubBuildId */
    private $buildId;
    ...
    public function setUp()
    {
        ...
        $this->sut       = new GitHubBuildPassed($this->buildId, $this->createdAt);
    }
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(GitHubBuildPassed::class, $result);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, GitHubBuildPassed::deserialize(json_decode($serialized, true)));
    }
}
