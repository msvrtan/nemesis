...
use Devboard\GitHubBuild\Domain\Event\GitHubBuildItemSuccess;
 ...
 * @covers \Devboard\GitHubBuild\Domain\Event\GitHubBuildItemSuccess
 * @group  todo
 */
class GitHubBuildItemSuccessTest extends TestCase
{
    /** @var GitHubBuildId */
    private $buildId;
    ...
    public function setUp()
    {
        ...
        $this->sut       = new GitHubBuildItemSuccess($this->buildId, $this->status, $this->createdAt);
    }
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(GitHubBuildItemSuccess::class, $result);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, GitHubBuildItemSuccess::deserialize(json_decode($serialized, true)));
    }
}
