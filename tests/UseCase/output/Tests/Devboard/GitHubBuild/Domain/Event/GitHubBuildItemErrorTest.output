 ...
 * @covers \Devboard\GitHubBuild\Domain\Event\GitHubBuildItemError
 * @group  todo
 */
class GitHubBuildItemErrorTest extends TestCase
{
    /** @var GitHubBuildId */
    private $buildId;
    ...
    public function setUp()
    {
        ...
        $this->sut       = new GitHubBuildItemError($this->buildId, $this->status, $this->createdAt);
    }
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(GitHubBuildItemError::class, $result);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, GitHubBuildItemError::deserialize(json_decode($serialized, true)));
    }
}
