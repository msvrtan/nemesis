...
use Devboard\GitHubBuild\Domain\Event\GitHubBuildFailed;
use PHPUnit\Framework\TestCase;

/**
 * @covers \Devboard\GitHubBuild\Domain\Event\GitHubBuildFailed
 * @group  todo
 */
class GitHubBuildFailedTest extends TestCase
{
    /** @var GitHubBuildId */
    private $buildId;
    ...
    public function setUp()
    {
        ...
        $this->sut       = new GitHubBuildFailed($this->buildId, $this->createdAt);
    }
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(GitHubBuildFailed::class, $result);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, GitHubBuildFailed::deserialize(json_decode($serialized, true)));
    }
}
