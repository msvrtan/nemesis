...
use Devboard\GitHubBuild\Domain\Event\GitHubBuildItemRestarted;
 ...
 * @covers \Devboard\GitHubBuild\Domain\Event\GitHubBuildItemRestarted
 * @group  todo
 */
class GitHubBuildItemRestartedTest extends TestCase
{
    /** @var GitHubBuildId */
    private $buildId;
    ...
    public function setUp()
    {
        ...
        $this->sut       = new GitHubBuildItemRestarted($this->buildId, $this->status, $this->createdAt);
    }
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(GitHubBuildItemRestarted::class, $result);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, GitHubBuildItemRestarted::deserialize(json_decode($serialized, true)));
    }
}
