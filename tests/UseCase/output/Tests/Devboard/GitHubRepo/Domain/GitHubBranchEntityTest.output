 ...
 * @covers \Devboard\GitHubRepo\Domain\GitHubBranchEntity
 * @group  todo
 */
class GitHubBranchEntityTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->deleted   = false;
        $this->sut       = new GitHubBranchEntity(
            $this->id, $this->name, $this->commit, $this->createdAt, $this->updatedAt, $this->deleted
        );
    }
