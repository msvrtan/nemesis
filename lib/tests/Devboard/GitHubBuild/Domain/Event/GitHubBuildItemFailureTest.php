...
use Devboard\GitHubBuild\Domain\Event\GitHubBuildItemFailure;
 ...
 * @covers \Devboard\GitHubBuild\Domain\Event\GitHubBuildItemFailure
 * @group  todo
 */
class GitHubBuildItemFailureTest extends TestCase
{
    /** @var GitHubBuildId */
    private $buildId;
    ...
    public function setUp()
    {
        ...
        $this->sut       = new GitHubBuildItemFailure($this->buildId, $this->status, $this->createdAt);
    }
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(GitHubBuildItemFailure::class, $result);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, GitHubBuildItemFailure::deserialize(json_decode($serialized, true)));
    }
}
