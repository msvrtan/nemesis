 ...
 * @covers \Devboard\GitHubBuild\Domain\Command\CreateGitHubBuild
 * @group  todo
 */
class CreateGitHubBuildTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut = new CreateGitHubBuild($this->gitHubBuildRootId, $this->referenceName, $this->commit);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, CreateGitHubBuild::deserialize(json_decode($serialized, true)));
    }
}
