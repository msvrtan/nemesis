 ...
 * @covers \Devboard\GitHubRepo\Domain\Event\GitHubTagCreated
 * @group  todo
 */
class GitHubTagCreatedTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut       = new GitHubTagCreated($this->id, $this->tag, $this->createdAt);
    }
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(GitHubTagCreated::class, $result);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, GitHubTagCreated::deserialize(json_decode($serialized, true)));
    }
}
