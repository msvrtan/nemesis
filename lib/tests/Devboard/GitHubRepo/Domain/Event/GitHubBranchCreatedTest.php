 ...
 * @covers \Devboard\GitHubRepo\Domain\Event\GitHubBranchCreated
 * @group  todo
 */
class GitHubBranchCreatedTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut       = new GitHubBranchCreated($this->id, $this->branch, $this->createdAt);
    }
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(GitHubBranchCreated::class, $result);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, GitHubBranchCreated::deserialize(json_decode($serialized, true)));
    }
}
