 ...
 * @covers \Devboard\GitHubRepo\Domain\Event\GitHubTagRecreated
 * @group  todo
 */
class GitHubTagRecreatedTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut         = new GitHubTagRecreated($this->id, $this->tag, $this->recreatedAt);
    }
    ...
    public function testCreate()
    {
        ...
        $result = $this->sut->create($id, $tag);
        self::assertInstanceOf(GitHubTagRecreated::class, $result);
    }
    ...
    {
        self::assertSame($this->tag, $this->sut->getTag());
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, GitHubTagRecreated::deserialize(json_decode($serialized, true)));
    }
}
