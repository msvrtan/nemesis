 ...
 * @covers \Devboard\GitHubRepo\Domain\Event\GitHubTagUpdated
 * @group  todo
 */
class GitHubTagUpdatedTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut       = new GitHubTagUpdated($this->id, $this->name, $this->commit, $this->updatedAt);
    }
    ...
    public function testCreate()
    {
        ...
        self::assertInstanceOf(GitHubTagUpdated::class, $result);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, GitHubTagUpdated::deserialize(json_decode($serialized, true)));
    }
}
