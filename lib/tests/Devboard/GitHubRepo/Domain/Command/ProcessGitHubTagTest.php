 ...
 * @covers \Devboard\GitHubRepo\Domain\Command\ProcessGitHubTag
 * @group  todo
 */
class ProcessGitHubTagTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sut = new ProcessGitHubTag($this->id, $this->tag);
    }
    ...
    public function testDeserialize()
    {
        ...
        self::assertEquals($this->sut, ProcessGitHubTag::deserialize(json_decode($serialized, true)));
    }
}
