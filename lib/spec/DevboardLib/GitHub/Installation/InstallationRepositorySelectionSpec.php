...
class InstallationRepositorySelectionSpec extends ObjectBehavior
{
    public function let()
    {
    ...
    {
        $this->shouldHaveType(InstallationRepositorySelection::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(InstallationRepositorySelection::class);
    }
}
