...
class StatusCreatorSpec extends ObjectBehavior
{
    public function let(
        AccountId $userId,
        AccountLogin $login,
    ...
    {
        $this->shouldHaveType(StatusCreator::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(StatusCreator::class);
    }
}
