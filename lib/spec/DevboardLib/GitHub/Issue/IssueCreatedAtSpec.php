...
class IssueCreatedAtSpec extends ObjectBehavior
{
    public function let()
    {
    ...
    {
        $this->shouldHaveType(IssueCreatedAt::class);
    ...
    {
        $this->deserialize('2018-01-01T11:22:33+00:00')->shouldReturnAnInstanceOf(IssueCreatedAt::class);
    }
}
