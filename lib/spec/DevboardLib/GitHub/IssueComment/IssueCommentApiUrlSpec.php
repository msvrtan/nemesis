...
class IssueCommentApiUrlSpec extends ObjectBehavior
{
    public function let()
    {
    ...
    {
        $this->shouldHaveType(IssueCommentApiUrl::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(IssueCommentApiUrl::class);
    }
}
