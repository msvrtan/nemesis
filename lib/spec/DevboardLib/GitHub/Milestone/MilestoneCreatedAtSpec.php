...
class MilestoneCreatedAtSpec extends ObjectBehavior
{
    public function let()
    {
    ...
    {
        $this->shouldHaveType(MilestoneCreatedAt::class);
    ...
    {
        $this->deserialize('2018-01-01T11:22:33+00:00')->shouldReturnAnInstanceOf(MilestoneCreatedAt::class);
    }
}
