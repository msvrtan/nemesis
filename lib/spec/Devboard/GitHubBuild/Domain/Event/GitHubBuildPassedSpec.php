...
class GitHubBuildPassedSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(GitHubBuildPassed::class);
    ...
    {
        $this->create($buildId)->shouldReturnAnInstanceOf(GitHubBuildPassed::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(GitHubBuildPassed::class);
    }
}
