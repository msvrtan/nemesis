...
class GitHubBuildItemSuccessSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(GitHubBuildItemSuccess::class);
    ...
    {
        $this->create($buildId, $status)->shouldReturnAnInstanceOf(GitHubBuildItemSuccess::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(GitHubBuildItemSuccess::class);
    }
}
