...
class GitHubBuildFailedSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(GitHubBuildFailed::class);
    ...
    {
        $this->create($buildId)->shouldReturnAnInstanceOf(GitHubBuildFailed::class);
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(GitHubBuildFailed::class);
    }
}
