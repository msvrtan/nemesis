 ...
 */
class PublicGitHubRepositoryInitializedSpec extends ObjectBehavior
{
    public function let(
        GitHubRepoRootId $id,
    ...
    {
        $this->shouldHaveType(PublicGitHubRepositoryInitialized::class);
    ...
    public function it_has_a_helper_factory_method(
        ...
        $this->create($id, $fullName, $owner, $description, $parent, $endpoints, $timestamps, $stats)->shouldReturnAnInstanceOf(
            PublicGitHubRepositoryInitialized::class
        );
    }
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(PublicGitHubRepositoryInitialized::class);
    }
}
