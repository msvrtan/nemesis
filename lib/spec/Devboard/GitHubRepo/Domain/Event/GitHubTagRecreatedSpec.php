...
use Devboard\GitHubRepo\Domain\Event\GitHubTagRecreated;
use DevboardLib\GitHub\GitHubTag;
use PhpSpec\ObjectBehavior;

class GitHubTagRecreatedSpec extends ObjectBehavior
{
    public function let(GitHubRepoRootId $id, GitHubTag $tag, DateTime $recreatedAt)
    {
        $this->beConstructedWith($id, $tag, $recreatedAt);
    }

    public function it_is_initializable()
    {
        $this->shouldHaveType(GitHubTagRecreated::class);
    ...
    {
        $this->create($id, $tag)->shouldReturnAnInstanceOf(GitHubTagRecreated::class);
    }
    ...
    public function it_exposes_recreated_at(DateTime $recreatedAt)
    {
        $this->getRecreatedAt()->shouldReturn($recreatedAt);
    }

    public function it_can_be_serialized(GitHubRepoRootId $id, GitHubTag $tag, DateTime $recreatedAt)
    {
        ...
        $recreatedAt->format('c')->shouldBeCalled()->willReturn('2018-01-01T00:01:00+00:00');
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(GitHubTagRecreated::class);
    }
}
