...
class GitHubBranchRecreatedSpec extends ObjectBehavior
{
    public function let(GitHubRepoRootId $id, GitHubBranch $branch, DateTime $recreatedAt)
    {
        $this->beConstructedWith($id, $branch, $recreatedAt);
    }

    public function it_is_initializable()
    {
        $this->shouldHaveType(GitHubBranchRecreated::class);
    ...
    {
        $this->create($id, $branch)->shouldReturnAnInstanceOf(GitHubBranchRecreated::class);
    }
    ...
    public function it_can_be_serialized(GitHubRepoRootId $id, GitHubBranch $branch, DateTime $recreatedAt)
    {
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(GitHubBranchRecreated::class);
    }
}
