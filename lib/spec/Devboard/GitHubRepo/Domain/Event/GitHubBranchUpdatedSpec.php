...
class GitHubBranchUpdatedSpec extends ObjectBehavior
{
    public function let(GitHubRepoRootId $id, BranchName $name, GitHubCommit $commit, DateTime $updatedAt)
    {
    ...
    {
        $this->shouldHaveType(GitHubBranchUpdated::class);
        $this->shouldImplement(GitHubBranchEvent::class);
        $this->shouldImplement(Serializable::class);
    }

    public function it_has_a_helper_factory_method(GitHubRepoRootId $id, BranchName $name, GitHubCommit $commit)
    {
        $this->create($id, $name, $commit)->shouldReturnAnInstanceOf(GitHubBranchUpdated::class);
    }
    ...
    public function it_can_be_serialized(
        GitHubRepoRootId $id, BranchName $name, GitHubCommit $commit, DateTime $updatedAt
    ) {
    ...
    public function it_can_be_deserialized()
    {
        ...
        $this->deserialize($input)->shouldReturnAnInstanceOf(GitHubBranchUpdated::class);
    }
}
