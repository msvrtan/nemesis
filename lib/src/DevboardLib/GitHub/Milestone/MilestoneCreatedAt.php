...
/**
 * @see \spec\DevboardLib\GitHub\Milestone\MilestoneCreatedAtSpec
 * @see \Tests\DevboardLib\GitHub\Milestone\MilestoneCreatedAtTest
 */
class MilestoneCreatedAt extends DateTime
{
