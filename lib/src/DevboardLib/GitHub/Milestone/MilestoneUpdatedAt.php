...
/**
 * @see \spec\DevboardLib\GitHub\Milestone\MilestoneUpdatedAtSpec
 * @see \Tests\DevboardLib\GitHub\Milestone\MilestoneUpdatedAtTest
 */
class MilestoneUpdatedAt extends DateTime
{
