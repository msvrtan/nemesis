...
/**
 * @see \spec\Devboard\GitHubBuild\Domain\Event\GitHubBuildItemCreatedSpec
 * @see \Tests\Devboard\GitHubBuild\Domain\Event\GitHubBuildItemCreatedTest
 */
class GitHubBuildItemCreated implements GitHubBuildEvent, GitHubBuildItemEvent, Serializable
{
    /** @var GitHubBuildId */
    private $buildId;
