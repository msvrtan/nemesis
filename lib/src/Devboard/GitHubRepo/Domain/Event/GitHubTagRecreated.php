...
/**
 * @see \spec\Devboard\GitHubRepo\Domain\Event\GitHubTagRecreatedSpec
 * @see \Tests\Devboard\GitHubRepo\Domain\Event\GitHubTagRecreatedTest
 */
class GitHubTagRecreated implements GitHubTagEvent, Serializable
{
    ...
    public function __construct(GitHubRepoRootId $id, GitHubTag $tag, DateTime $recreatedAt)
    {
        $this->id          = $id;
        $this->tag         = $tag;
