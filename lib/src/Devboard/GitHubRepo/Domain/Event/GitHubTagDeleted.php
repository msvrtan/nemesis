...
/**
 * @see \spec\Devboard\GitHubRepo\Domain\Event\GitHubTagDeletedSpec
 * @see \Tests\Devboard\GitHubRepo\Domain\Event\GitHubTagDeletedTest
 */
class GitHubTagDeleted implements GitHubTagEvent, Serializable
{
    ...
    public function __construct(GitHubRepoRootId $id, TagName $name, DateTime $deletedAt)
    {
        $this->id        = $id;
        $this->name      = $name;
    ...
    public static function create(GitHubRepoRootId $id, TagName $name): self
    {
